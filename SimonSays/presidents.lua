...
t.create = function(screenGroup, callbackFunc)
	dog = display.newImageRect( "images/kennedy.png", 187, 170 )
	cat = display.newImageRect( "images/washington.png", 201, 206 )
	cow = display.newImageRect( "images/lincoln.png", 197, 222 )
