...
t.create = function(screenGroup, callbackFunc)
	dog = display.newImageRect( "images/gold.png", 200, 200 )
	cat = display.newImageRect( "images/silver.png", 200, 200 )
	cow = display.newImageRect( "images/copper.png", 200, 200 )

	dogText = "the GOLD chemical symbol"
	catText = "the SILVER chemical symbol"
	cowText = "the COPPER chemical symbol"
