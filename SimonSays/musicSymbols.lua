...
t.create = function(screenGroup, callbackFunc)
	dog = display.newImageRect( "images/minim.png", 150, 180 )
	cat = display.newImageRect( "images/crotchet.png", 150, 180 )
	cow = display.newImageRect( "images/quaver.png", 150, 207 )

	dogText = "the minim"
	catText = "the crotchet"
	cowText = "the quaver"
