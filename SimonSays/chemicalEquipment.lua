...
t.create = function(screenGroup, callbackFunc)
	dog = display.newImageRect( "images/conical.png", 180, 180 )
	cat = display.newImageRect( "images/testtube.png", 160, 240 )
	cow = display.newImageRect( "images/volumetric.png", 180, 180 )

	dogText = "the conical flask"
	catText = "the test tube"
	cowText = "the volumetric flask"
