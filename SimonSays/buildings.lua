...
t.create = function(screenGroup, callbackFunc)
	dog = display.newImageRect( "images/leaning.png", 144, 250 )
	cat = display.newImageRect( "images/eiffel.png", 144, 250 )
	cow = display.newImageRect( "images/liberty.png", 144, 250 )
...
t.showOnScreen = function(difficulty, text2)
	...
	if expectedAnimal == 1 then
		cat.isCorrect = true
		text2.text = text2.text .. "Eiffel Tower"
	elseif expectedAnimal == 2 then
		dog.isCorrect = true
		text2.text = text2.text .. "Leaning Tower of Pisa"
	elseif expectedAnimal == 3 then
		cow.isCorrect = true
		text2.text = text2.text .. "Statue of Liberty"
	end
