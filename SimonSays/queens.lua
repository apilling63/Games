...
t.create = function(screenGroup, callbackFunc)
	dog = display.newImageRect( "images/anneBoleyn.png", 170, 189 )
	cat = display.newImageRect( "images/queenVictoria.png", 178, 223 )
	cow = display.newImageRect( "images/queenElizabeth.png", 174, 232 )

	dogText = "Anne Boleyn"
	catText = "Queen Victoria"
	cowText = "Queen Elizabeth"
