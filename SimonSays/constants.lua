...
t.create = function(screenGroup, callbackFunc)
	dog = display.newImageRect( "images/3.png", 150, 150 )
	cat = display.newImageRect( "images/e.jpeg", 150, 150 )
	cow = display.newImageRect( "images/pi.png", 150, 150 )

	dogText = "root 9"
	catText = "the smallest"
	cowText = "the largest"
