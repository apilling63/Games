...
t.create = function(screenGroup, callbackFunc)
	dog = display.newImageRect( "images/picasso.png", 170, 208 )
	cat = display.newImageRect( "images/monalisa.png", 182, 276 )
	cow = display.newImageRect( "images/lillies.png", 200, 126 )

	dogText = "the Picasso"
	catText = "the Da Vinci"
	cowText = "the Monet"
