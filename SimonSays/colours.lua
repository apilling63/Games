...
t.create = function(screenGroup, callbackFunc)
	dog = display.newImageRect( "images/smaragdine.png", 150, 150 )
	cat = display.newImageRect( "images/sarcoline.png", 150, 150 )
	cow = display.newImageRect( "images/coquelicot.png", 150, 150 )

	dogText = "the smaragdine"
	catText = "the sarcoline"
	cowText = "the coquelicot"
