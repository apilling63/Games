...
function u.addSpiralSprite(screenGroup)
	local playerSheetData = { width=200, height=200, numFrames=8, sheetContentWidth=1600, sheetContentHeight=200 }
...
function u.addSwitchSprite(screenGroup)
	local playerSheetData = { width=680, height=150, numFrames=2, sheetContentWidth=680, sheetContentHeight=300 }
