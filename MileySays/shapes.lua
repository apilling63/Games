...
t.create = function(screenGroup, callbackFunc)
	dog = display.newImageRect( "images/triangle.png", 137, 122 )
	cat = display.newImageRect( "images/square.png", 137, 133 )
	cow = display.newImageRect( "images/hexagon.png", 130, 130 )

	dogText = "the triangle"
	catText = "the square"
	cowText = "the hexagon"
