...
t.create = function(screenGroup, callbackFunc)
	dog = display.newImageRect( "images/khanda.png", 202, 249 )
	cat = display.newImageRect( "images/starOfDavid.png", 200, 231 )
	cow = display.newImageRect( "images/crossOfJesus.png", 181, 279 )

	dogText = "the Khanda"
	catText = "the Star of David"
	cowText = "the Cross of Jesus"
