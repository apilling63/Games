...
t.create = function(screenGroup, callbackFunc)
	dog = display.newImageRect( "images/point75.png", 150, 100 )
	cat = display.newImageRect( "images/point25.png", 150, 100 )
	cow = display.newImageRect( "images/point5.png", 150, 100 )

	dogText = "three quarters"
	catText = "one quarter"
	cowText = "one half"
