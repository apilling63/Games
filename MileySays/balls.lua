...
t.create = function(screenGroup, callbackFunc)
	dog = display.newImageRect( "images/football.png", 275, 183 )
	cat = display.newImageRect( "images/tennisball.png", 225, 225 )
	cow = display.newImageRect( "images/shuttlecock.png", 248, 204 )

	dogText = "the football"
	catText = "the tennis ball"
	cowText = "the shuttlecock"

	utility.centreObjectX(dog)
	utility.centreObjectY(dog)
	dog:translate(1880, 310)
