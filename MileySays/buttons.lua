...
t.create = function(screenGroup, callbackFunc)
	dog = display.newImageRect( "images/greenButton.png", 150, 150 )
	cat = display.newImageRect( "images/redButton.png", 150, 150 )
	cow = display.newImageRect( "images/blueButton.png", 150, 150 )
...
t.showOnScreen = function(difficulty, text2)
	...
	if expectedAnimal == 1 then
		cat.isCorrect = true
		text2.text = text2.text .. "red button"
	elseif expectedAnimal == 2 then
		dog.isCorrect = true
		text2.text = text2.text .. "green button"
	elseif expectedAnimal == 3 then
		cow.isCorrect = true
		text2.text = text2.text .. "blue button"
	end
