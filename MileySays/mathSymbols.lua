...
t.create = function(screenGroup, callbackFunc)
	dog = display.newImageRect( "images/greaterThan.png", 200, 200 )
	cat = display.newImageRect( "images/lessThan.png", 200, 200 )
	cow = display.newImageRect( "images/equals.png", 200, 200 )

	dogText = "greater than"
	catText = "less than"
	cowText = "equals"
