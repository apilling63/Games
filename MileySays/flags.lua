...
t.create = function(screenGroup, callbackFunc)
	dog = display.newImageRect( "images/us.png", 95, 75 )
	cat = display.newImageRect( "images/uk.png", 95, 75 )
	cow = display.newImageRect( "images/thai.png", 95, 75 )

	dogText = "the US flag"
	catText = "the UK flag"
	cowText = "the Thailand flag"
