...
t.create = function(screenGroup, callbackFunc)
	dog = display.newImageRect( "images/hamster.jpeg", 248, 203 )
	cat = display.newImageRect( "images/guineapig.jpeg", 275, 183 )
	cow = display.newImageRect( "images/rabbit.jpeg", 240, 180 )

	dogText = "the hamster"
	catText = "the guinea pig"
	cowText = "the rabbit"
