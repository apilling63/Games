...
t.create = function(screenGroup, callbackFunc)
	dog = display.newImageRect( "images/ukireland.png", 178, 251 )
	cat = display.newImageRect( "images/australia.png", 233, 217 )
	cow = display.newImageRect( "images/iceland.png", 272, 186 )

	dogText = "the UK and Ireland"
	catText = "Australia"
	cowText = "Iceland"
