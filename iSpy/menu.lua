...
function scene:createScene(event)
	...
	utility.setColour(background, 243,247,227)

	local fan = utility.addNewPicture("magnifyingGlass.png", screenGroup)
	fan.x = display.contentWidth / 2 - 1400
	fan.y = display.contentHeight / 2 - 20
								
	local textLine2 = utility.addBlackCentredTextWithFont("I SPY", 
								-190, 
								screenGroup, 
								100, 
								"Quicksand")
	utility.setColour(textLine2, 0, 0, 0)
	...
	playText = utility.addCentredText("PLAY", 
							...
							50, 
							"Quicksand")				
	utility.setColour(playText, 87, 190, 199)
