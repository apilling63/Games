	...
	if inPlay and whirl == nil then
		...
		if scoreCounter > (3000 + (500 * gameData.chosenLevel)) then
			...
			elseif gameData.chosenLevel > 10 and randomChoice == 2 then
				...
				local spike2 = utility.addSpike(screenGroup)
				spike2.rotation = 180
